    ...
    <div className="relative">
          ...
          <div className="max-w-4xl">
            ...
            <div className="flex flex-wrap items-center gap-4">
              ...
              <a href="https://discord.com/invite/OvertakeSector" target="_blank" rel="noopener noreferrer"
                className="flex items-center gap-2 text-[#5865F2] hover:text-[#F2F2F2] border border-[#5865F2]/20 hover:border-[#5865F2]/50 hover:bg-[#5865F2]/10 px-5 py-4 text-sm font-medium transition-all">
              ...
              <a key={article.id} href={article.link} target="_blank" rel="noopener noreferrer"
                ...
                <div className="p-5">
                  ...
                  <div className="flex items-center gap-2 mt-4 text-xs text-[#E8191A] font-medium">
                    Read on X <ChevronRight size={12} />
                  </div>
                </div>
              </a>
            ))}
      ...
      <section className="relative py-28 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-6 text-center">
          ...
          <a href="https://discord.com/invite/OvertakeSector" target="_blank" rel="noopener noreferrer"
            className="inline-flex items-center gap-3 bg-[#5865F2] hover:bg-[#4752c4] px-10 py-5 font-bold tracking-widest uppercase text-base transition-all hover:shadow-[0_0_40px_rgba(88,101,242,0.4)] text-[#F2F2F2]"
            style={{ fontFamily: 'Barlow Condensed, sans-serif' }}>
