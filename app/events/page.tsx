...
import { ChevronRight, Calendar, Clock, MapPin, Trophy, Users, Tv } from 'lucide-react'
  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-6 py-20 space-y-20">
        ...
        {/* More Upcoming Events — placeholder for future events */}
        <div>
          <div className="flex items-center gap-3 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              { title: 'Community Night', category: 'COMMUNITY', game: 'TBA', desc: 'Join the Overtake Discord for a community gaming night. Details coming soon.', icon: Users },
              { title: 'Creator Stream Takeover', category: 'CREATOR STREAM', game: 'TBA', desc: 'Overtake creators go live together. Platform and schedule TBA.', icon: Tv },
              { title: 'Open Tryouts', category: 'TRYOUTS', game: 'Multiple', desc: 'Season 2026 tryouts are open. Apply now to compete for a roster spot.', icon: Trophy },
            ].map((event, i) => {
